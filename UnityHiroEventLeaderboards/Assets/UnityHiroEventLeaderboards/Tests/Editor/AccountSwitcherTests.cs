...
namespace HiroEventLeaderboards.Tests.Editor
{
    ...
    public class AccountSwitcherTests
    {
        ...
        private const string TestEnv = "local";
        ...
        public async Task AccountSwitcher_HasFourAccounts_AllExistOnServer()
        {
            ...
            {
                var session = await AccountSwitcher.AuthenticateDeviceAsync(_client, TestEnv, i);
        ...
        public async Task AccountSwitcher_StoredAccounts_MatchServerAccounts()
        {
            ...
            var session = await AccountSwitcher.AuthenticateDeviceAsync(_client, TestEnv, 0);
