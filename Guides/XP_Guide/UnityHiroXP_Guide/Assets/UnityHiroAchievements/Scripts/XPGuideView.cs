...
namespace XPGuide
{
    public sealed class XPGuideView : IDisposable
    {
        ...
        public XPGuideView(XPController controller, VisualElement rootElement, VisualTreeAsset questItemTemplate)
        {
        ...
        // Called every frame from XPGuideViewBehaviour.Update().
