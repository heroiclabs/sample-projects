...
namespace FriendCodes
{
    public class FriendsRecordView
    {
        ...
        private FriendCodesController friendsController;

        public void SetVisualElement(VisualElement visualElement, FriendCodesController controller)
        {
        ...
        public void SetFriend(IApiFriend record)
        {
            ...
            var state = (FriendCodesController.FriendState)record.State;

            switch (state)
            {
                case FriendCodesController.FriendState.Friend:
                    ...
                    break;
                case FriendCodesController.FriendState.InviteSent:
                    addButton.style.display = DisplayStyle.None;
                    removeButton.style.display = DisplayStyle.Flex;
                    blockButton.style.display = DisplayStyle.None;
                    unblockButton.style.display = DisplayStyle.None;
                    break;
                case FriendCodesController.FriendState.InviteReceived:
                    addButton.style.display = DisplayStyle.Flex;
                    removeButton.style.display = DisplayStyle.Flex;
                    blockButton.style.display = DisplayStyle.Flex;
                    unblockButton.style.display = DisplayStyle.None;
                    break;
                case FriendCodesController.FriendState.Blocked:
                    addButton.style.display = DisplayStyle.None;
