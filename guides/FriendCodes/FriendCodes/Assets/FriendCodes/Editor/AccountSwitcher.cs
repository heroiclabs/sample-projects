...
namespace FriendCodes.Editor
{
    public class AccountSwitcherEditor : EditorWindow
    {
        ...
        private void CreateGUI()
        {
            ...
            {
                if (!rootGameObject.TryGetComponent<FriendCodesController>(out var friendsController)) continue;
        ...
        private void OnControllerInitialized(ISession session, FriendCodesController controller = null)
        {
